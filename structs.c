...
void queue_free(Queue *q) { list_free((List *)q); }
void queue_enqueue(Queue *q, void *data) { list_append((List *)q, data); }

void *queue_dequeue(Queue *q) { return list_get_first((List *)q); }
